...
with open('PreferredMetaphorJune18_TextProofread.csv', 'r+', newline='') as csvfile:
...
with open('Tokenized_Sculptor.csv', 'w+', newline='') as csvfile:
...
with open('Tokenized_Gardener.csv', 'w+', newline='') as csvfile:
    filewriter = csv.writer(
        csvfile, 
        delimiter=',', 
        quotechar='|', 
...
with open('Tokenized_Coach.csv', 'w+', newline='') as csvfile:
    filewriter = csv.writer(
        csvfile, 
        delimiter=',', 
        quotechar='|', 
...
with open('Tokenized_AppStore.csv', 'w+', newline='') as csvfile:
    filewriter = csv.writer(
        csvfile, 
        delimiter=',', 
        quotechar='|', 
...
with open('Tokenized_TourGuide.csv', 'w+', newline='') as csvfile:
    filewriter = csv.writer(
        csvfile, 
        delimiter=',', 
        quotechar='|', 
...
with open('Tokenized_Captain.csv', 'w+', newline='') as csvfile:
    filewriter = csv.writer(
        csvfile, 
        delimiter=',', 
        quotechar='|', 
